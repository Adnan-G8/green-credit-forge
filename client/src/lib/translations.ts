...
export const translations = {
  ...
  en: {
    ...
    'security-3fa-details': 'Access to the platform is secured via:\n\n• Certified user identity\n• Authorized device (computer, smartphone, etc.)\n• Active user session\n• Obligatory digital fingerprint for ecosystem of trust and respect',
    ...
    'security-data-sovereignty-description': 'Your Data. Our Fortress. Swiss Precision for a Global Platform.',
    'security-data-sovereignty-subtitle': 'Our infrastructure is designed to connect nations worldwide and enable international applications. To ensure the highest data sovereignty and neutrality, we rely on a specialized Swiss service provider for secure data management.',
    'security-data-sovereignty-point1': 'Strictest Data Protection Laws: subject to the New Federal Act on Data Protection (nFADP), one of the world\'s strictest data protection laws',
    'security-data-sovereignty-point2': 'FINMA Standards: infrastructure meets Swiss Financial Market Supervisory Authority requirements (FINMA-RS 18/3 compliance)',
    'security-data-sovereignty-point3': 'Unrivalled Physical Security: data centers in Alpine fortresses, former Swiss military bunkers repurposed into state-of-the-art data centers',
    'security-alpine-details': 'Our primary data centers are strategically located in former Swiss military bunkers deep in the Alps, offering unparalleled physical security and natural protection from both environmental and human threats.',
    'security-alpine-point1': 'EMP-resistant military bunkers',
    'security-alpine-point2': 'Autonomous power and cooling systems', 
    'security-alpine-point3': 'Multi-ton security doors with biometric access',
