...
export const translations = {
  it: {
    ...
    'renewable-energy-projects': 'Progetti da Fonti Rinnovabili',
    ...
    'full-platform-access': 'Accesso Completo Piattaforma',
  ...
  'renewable-energy-projects': 'Renewable Energy Projects',
    ...
    'legal-entity-documentation': 'Legal Entity Documentation',
    'complete-legal-entity-documentation': 'Complete legal entity documentation according to UNI/PdR guidelines',
    'legal-entity-information': 'Legal Entity Information',
    'legal-entity-description': 'Enter mandatory legal data of the organization according to UNI/PdR FAGRI Digital regulations',
    ...
    'fiscal-code': 'Fiscal Code',
    'enter-fiscal-code': 'Enter fiscal code',
    'chamber-commerce-registration': 'Chamber of Commerce Registration',
    'enter-registration-number': 'Enter registration number',
    'legal-registered-address': 'Legal Registered Address',
    'enter-complete-legal-address': 'Enter complete legal registered address',
    'operational-headquarters-address': 'Operational Headquarters',
    'enter-operational-address': 'Enter operational address (if different from legal)',
    'pec-address': 'PEC Address',
    'legal-representative': 'Legal Representative',
    'full-name-legal-representative': 'Full name of legal representative',
    'technical-manager': 'Technical Manager',
    'full-name-technical-manager': 'Full name of technical manager',
    'agricultural-assets-facilities': 'Agricultural Assets & Facilities',
    ...
    'forest-agroforest-hectares': 'Forest/Agroforest Land (hectares)',
    'irrigated-area-hectares': 'Irrigated Area (hectares)',
    'machinery-equipment-inventory': 'Machinery & Equipment Inventory',
    'describe-agricultural-machinery': 'Describe agricultural machinery, tractors, equipment and technical means',
    'buildings-structures-inventory': 'Buildings & Structures Inventory',
    ...
    'describe-compliance-documentation': 'Describe documentation for audit and regulatory compliance',
    ...
    'planned-co2-projects': 'Planned CO₂ Projects',
    'select-project-scope': 'Select project scope',
    'agriculture-only': 'Agriculture Only',
    'forestry-only': 'Forestry Only',
    'renewable-energy-only': 'Renewable Energy Only',
    'agriculture-forestry': 'Agriculture + Forestry',
    'agriculture-renewable': 'Agriculture + Renewable',
    'forestry-renewable': 'Forestry + Renewable',
    'all-three-sectors': 'All Three Sectors',
    'expected-annual-co2-capture': 'Expected Annual CO₂ Capture',
    'tonnes-co2-per-year': 'Tonnes CO₂/year',
    'project-duration-years': 'Project Duration (years)',
    'years': 'years',
    'investment-capacity-euros': 'Investment Capacity (€)',
    'step': 'Step',
    'of': 'of',
    'previous': 'Previous',
    'next': 'Next',
    ...
    'certification-pricing-structure': 'Certification Pricing Structure',
    'environmental-compensation-projects': 'Environmental Compensation Projects',
    'carbon-credit-creation-fees': 'Fees for carbon credit creation via bank transfer',
    'renewable-energy-projects': 'Renewable Energy Projects',
    'renewable-carbon-credit-fees': 'Fees for renewable energy carbon credits',
    'price-per-hectare': 'Price per hectare of land used',
    'project-size-hectares': 'Total project size in hectares',
    ...
    'price-per-kw': 'Price per kW of plant capacity',
    'project-size-kw': 'Total project size in kW',
    ...
    'payment-method-bank-transfer': 'Payment to be made via bank transfer to FAGRI DIGITAL Certification System',
    'address': 'Address',
    ...
    'invalid-id-desc': 'Please enter a valid ALPHAG8 ID KEY in the correct format.',
