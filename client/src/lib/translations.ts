...
export const translations = {
  it: {
    ...
    'co2-cert-compliance-kyoto-desc': 'Costruire sui principi contabili internazionali consolidati.',
    'co2-cert-technology-title': 'Tecnologia e Sicurezza',
    'co2-cert-technology-description': 'La nostra piattaforma sfrutta la tecnologia blockchain per l\'archiviazione immutabile dei documenti, creando una trasparenza senza pari ed eliminando problemi come il doppio conteggio e il greenwashing.',
    'co2-cert-tech-blockchain': 'Blockchain Technology',
    'co2-cert-tech-blockchain-desc': 'Archiviazione immutabile e trasparenza completa per tutti i documenti.',
  ...
  en: {
    ...
    'security-3fa-details': 'Access to the platform is secured via: Certified user identity, Authorized device (computer, smartphone, etc.), Active user session, Obligatory digital fingerprint for ecosystem of trust and respect',
    ...
    'security-digital-fingerprint-details': 'Obligatory Digital Fingerprint for Every User and Active Member. For an ecosystem of trust and respect, every user and active member on the platform must provide their obligatory digital fingerprint. This ensures accountability, transparency, and a secure environment for all participants. Users must go through a KYC process in order to create their digital fingerprint. After the Digital Fingerprint is issued the Data and all other informations are highly encrypted on a seperate server structurte to protect it against every and all misues. All this information are only used for legal and regulation processing and nothing else and not shared with any other organisation.',
    'security-digital-fingerprint-kyc': 'Complete KYC Verification',
    'security-data-sovereignty-title': 'Data Sovereignty & Access Control',
    'security-data-sovereignty-description': 'Your Data. Our Fortress. Swiss Precision for a Global Platform. Our infrastructure is designed to connect nations worldwide and enable international applications. To ensure the highest data sovereignty and neutrality, we rely on a specialized Swiss service provider for secure data management.',
    'security-data-sovereignty-details': 'Strictest Data Protection Laws: subject to the New Federal Act on Data Protection (nFADP), one of the world\'s strictest data protection laws. FINMA Standards: infrastructure meets Swiss Financial Market Supervisory Authority requirements (FINMA-RS 18/3 compliance). Unrivalled Physical Security: data centers in Alpine fortresses, former Swiss military bunkers repurposed into state-of-the-art data centers.',
    'security-alpine-details': 'Our primary data centers are strategically located in former Swiss military bunkers deep in the Alps, offering unparalleled physical security and natural protection from both environmental and human threats. EMP-resistant military bunkers, Autonomous power and cooling systems, Multi-ton security doors with biometric access',
