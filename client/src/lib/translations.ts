export const translations = {
  it: {
    ...
    'security-integrity-title': 'Integrità Digitale e Tracciabilità',
    'security-integrity-description': 'Ogni azione della piattaforma è crittografata, inalterabile e non cancellabile. Questo garantisce responsabilità verificabile, protegge i richiedenti e rafforza la credibilità di fronte a revisori e autorità.',
    'security-blockchain-title': 'Blockchain come Garanzia di Integrità',
    'security-blockchain-intro': 'La tecnologia blockchain integrata in FAGRI.Digital è uno strumento concreto per garantire sicurezza, trasparenza e prevenzione delle frodi:',
    'security-blockchain-feature1': 'Tutti i documenti essenziali (progetti, report, attestazioni) sono conservati in modo immutabile e verificabile',
    'security-blockchain-feature2': 'Ogni credito di carbonio riceve un identificativo univoco e viene automaticamente ritirato dopo l\'uso',
    'security-blockchain-feature3': 'Tutte le transazioni sono cronologiche, distribuite e pubblicamente verificabili',
  ...
  en: {
    ...
    'security-integrity-title': 'Digital Integrity & Traceability',
    'security-integrity-description': 'Every platform action is encrypted, unalterable, and non-deletable. This ensures verifiable responsibility, protects applicants, and strengthens credibility in front of auditors and authorities.',
    'security-blockchain-title': 'Blockchain as a Guarantee of Integrity',
    'security-blockchain-intro': 'The blockchain technology integrated into FAGRI.Digital is a concrete tool for ensuring security, transparency, and fraud prevention:',
    'security-blockchain-feature1': 'All essential documents (projects, reports, attestations) are stored immutably and verifiably',
    'security-blockchain-feature2': 'Each carbon credit is assigned a unique identifier and is automatically retired after use',
    'security-blockchain-feature3': 'All transactions are chronological, distributed, and publicly verifiable',
