export const translations = {
  it: {
    ...
    'business-hierarchy-desc': 'Seleziona il tuo settore principale, poi specifica la categoria e le attività specifiche',
    'main-business-sector': 'Settore Principale',
    'select-main-sector': 'Seleziona Settore Principale',
    'business-sub-sector': 'Sotto-Settore',
    'select-sub-sector': 'Seleziona Sotto-Settore',
    'specific-activities': 'Attività Specifiche',
    'multiple-choice': 'Scelta Multipla',
    'selected-activities': 'Attività Selezionate',
    'additional-business-info': 'Informazioni Aggiuntive',
    'describe-additional-info': 'Descrivi informazioni aggiuntive sulla tua attività...',
    
    // Main Business Sectors
    'farmer-producer': 'Agricoltore/Produttore',
    'cooperative-association': 'Cooperativa/Associazione',
    'agricultural-industry': 'Industria Agroalimentare',
    'renewable-energy': 'Energie Rinnovabili',
    'agri-services': 'Servizi Agricoli',
    
    // Farmer-Producer Sub-sectors
    'crop-production': 'Produzione Cerealicola',
    'livestock-farming': 'Allevamento Zootecnico',
    'dairy-farming': 'Allevamento Lattiero-Caseario',
    'viticulture': 'Viticoltura',
    'olive-production': 'Olivicoltura',
    'fruit-growing': 'Frutticoltura',
    'organic-farming': 'Agricoltura Biologica',
    'mixed-farming': 'Agricoltura Mista',
    
    // Cooperative Sub-sectors
    'agricultural-cooperative': 'Cooperativa Agricola',
    'wine-cooperative': 'Cooperativa Vinicola',
    'dairy-cooperative': 'Cooperativa Lattiero-Casearia',
    'fruit-vegetable-cooperative': 'Cooperativa Ortofrutticola',
    'marketing-cooperative': 'Cooperativa di Commercializzazione',
    'supply-cooperative': 'Cooperativa di Approvvigionamento',
    
    // Industry Sub-sectors
    'food-processing': 'Trasformazione Alimentare',
    'dairy-industry': 'Industria Lattiero-Casearia',
    'wine-industry': 'Industria Vinicola',
    'olive-oil-production': 'Produzione Olio d\'Oliva',
    'grain-milling': 'Molitoria',
    'meat-processing': 'Lavorazione Carni',
    'agricultural-machinery': 'Macchine Agricole',
    'fertilizer-production': 'Produzione Fertilizzanti',
    
    // Renewable Energy Sub-sectors
    'solar-farms': 'Fattorie Solari',
    'wind-energy': 'Energia Eolica',
    ...
    'certification-services': 'Servizi di Certificazione',
    'logistics-transport': 'Logistica e Trasporti',
    'agricultural-technology': 'Tecnologie Agricole',
    'financing-services': 'Servizi Finanziari',
    'insurance-services': 'Servizi Assicurativi',

    // Specific Activities - Farmer-Producer
    'cereals': 'Cereali',
    'vegetables': 'Ortaggi',
    'legumes': 'Leguminose',
    'oilseeds': 'Semi Oleosi',
    'industrial-crops': 'Colture Industriali',
    'cattle': 'Bovini',
    'sheep': 'Ovini',
    'goats': 'Caprini',
    'pigs': 'Suini',
    ...
    'milk-production': 'Produzione Latte',
    'cheese-making': 'Caseificazione',
    'yogurt-production': 'Produzione Yogurt',
    'organic-dairy': 'Lattiero Biologico',
    'wine-grapes': 'Uve da Vino',
    'table-grapes': 'Uve da Tavola',
    'organic-wine': 'Vino Biologico',
    'sparkling-wine': 'Vino Spumante',
    'oil-olives': 'Olive da Olio',
    'table-olives': 'Olive da Tavola',
    'organic-olives': 'Olive Biologiche',
    'premium-oil': 'Olio Premium',
    'citrus': 'Agrumi',
    'stone-fruits': 'Frutti con Nocciolo',
    'berries': 'Frutti di Bosco',
    'nuts': 'Frutta Secca',
    'tropical-fruits': 'Frutti Tropicali',
    'organic-cereals': 'Cereali Biologici',
    'organic-vegetables': 'Ortaggi Biologici',
    'organic-livestock': 'Zootecnia Biologica',
    'biodynamic': 'Biodinamico',
    'crop-livestock': 'Agro-Zootecnico',
    'agrotourism': 'Agriturismo',
    'direct-sales': 'Vendita Diretta',
    'farm-to-table': 'Prodotto-Tavola',

    // Cooperative Activities
    'member-services': 'Servizi Soci',
    'bulk-purchasing': 'Acquisti Collettivi',
    'marketing-support': 'Supporto Marketing',
    'storage-facilities': 'Impianti Stoccaggio',
    'grape-processing': 'Lavorazione Uve',
    'wine-production': 'Produzione Vino',
    'bottling': 'Imbottigliamento',
    'marketing': 'Marketing',
    'milk-collection': 'Raccolta Latte',
    ...
    'brand-development': 'Sviluppo Marca',
    'sales-channels': 'Canali Vendita',
    'export': 'Esportazione',
    'promotion': 'Promozione',
    'input-purchasing': 'Acquisto Input',
    'equipment-sharing': 'Condivisione Attrezzature',
    'technical-support': 'Supporto Tecnico',
    'financing': 'Finanziamento',

    // Industry Activities
    'preservation': 'Conservazione',
    'value-addition': 'Valorizzazione',
    'ready-meals': 'Piatti Pronti',
    'pasteurization': 'Pastorizzazione',
    'cheese-production': 'Produzione Formaggi',
    'powder-production': 'Produzione Polveri',
    'fermented-products': 'Prodotti Fermentati',
    'winemaking': 'Vinificazione',
    'aging': 'Invecchiamento',
    'blending': 'Assemblaggio',
    'extraction': 'Estrazione',
    'refining': 'Raffinazione',
    'quality-testing': 'Test Qualità',
    'flour-production': 'Produzione Farina',
    'feed-production': 'Produzione Mangimi',
    'grain-cleaning': 'Pulitura Cereali',
    'storage': 'Stoccaggio',
    'slaughtering': 'Macellazione',
    'butchering': 'Lavorazione Carni',
    'manufacturing': 'Produzione',
    'sales': 'Vendite',
    'maintenance': 'Manutenzione',
    'technology-development': 'Sviluppo Tecnologie',
    'organic-fertilizers': 'Fertilizzanti Organici',
    'mineral-fertilizers': 'Fertilizzanti Minerali',
    'specialty-products': 'Prodotti Speciali',
    'research': 'Ricerca',

    // Renewable Energy Activities
    'photovoltaic-systems': 'Sistemi Fotovoltaici',
    'solar-thermal': 'Solare Termico',
    'grid-connection': 'Connessione Rete',
    'wind-turbines': 'Turbine Eoliche',
    'grid-integration': 'Integrazione Rete',
    'biomass-production': 'Produzione Biomasse',
    'energy-conversion': 'Conversione Energetica',
    'waste-management': 'Gestione Rifiuti',
    'sustainability': 'Sostenibilità',
    'anaerobic-digestion': 'Digestione Anaerobica',
    'gas-upgrading': 'Upgrading Gas',
    'electricity-generation': 'Generazione Elettrica',
    'heat-production': 'Produzione Calore',
    'dual-use-systems': 'Sistemi Doppio Uso',
    'crop-energy-optimization': 'Ottimizzazione Coltura-Energia',
    'development': 'Sviluppo',
    'battery-systems': 'Sistemi Batterie',
    'grid-services': 'Servizi Rete',
    'peak-shaving': 'Peak Shaving',
    'backup-power': 'Alimentazione Emergenza',
    'electrolysis': 'Elettrolisi',
    'transport': 'Trasporto',
    'industrial-applications': 'Applicazioni Industriali',

    // Services Activities
    'technical-advice': 'Consulenza Tecnica',
    'business-planning': 'Pianificazione Aziendale',
    'sustainability-consulting': 'Consulenza Sostenibilità',
    'certification-support': 'Supporto Certificazione',
    'organic-certification': 'Certificazione Biologica',
    'co2-certification': 'Certificazione CO₂',
    'auditing': 'Audit',
    'farm-to-market': 'Campo-Mercato',
    'cold-chain': 'Catena Freddo',
    'warehousing': 'Magazzinaggio',
    'precision-agriculture': 'Agricoltura Precisione',
    'iot-sensors': 'Sensori IoT',
    'data-analytics': 'Analisi Dati',
    'automation': 'Automazione',
    'agricultural-loans': 'Prestiti Agricoli',
    'investment-funding': 'Finanziamento Investimenti',
    'insurance-products': 'Prodotti Assicurativi',
    'risk-management': 'Gestione Rischi',
    'crop-insurance': 'Assicurazione Raccolti',
    'livestock-insurance': 'Assicurazione Bestiame',
    'equipment-insurance': 'Assicurazione Attrezzature',
    'liability-coverage': 'Copertura Responsabilità',
    ...
    // Renewable Energy Types (legacy - now in hierarchical system)
    ...
    // ALPHAG8 ID KEY Section Translations
    'alphag8-secure-access': 'Accesso Sicuro. Nessuna Password. Nessun Problema.',
    'three-factor-auth': 'Autenticazione a Tre Fattori (3FA)',
    'alphag8-description': 'L\'ALPHAG8 ID KEY è la tua impronta digitale personale – uno strato di sicurezza intelligente e invisibile che utilizza il tuo dispositivo (smartphone o computer) come chiave di accesso unica. Nessuna password, nessun codice SMS, nessun token – solo accesso fluido basato su chi sei e cosa usi.',
    'three-factor-title': 'Autenticazione a 3 Fattori:',
    'three-factor-desc': 'Combina hardware, software e pattern di utilizzo del tuo dispositivo',
    'zero-trust-title': 'Sicurezza Zero-Trust:',
    'zero-trust-desc': 'Ogni accesso è completamente ri-validato – nessuna scorciatoia, nessun riutilizzo',
    'phone-key-title': 'Il Tuo Telefono = La Tua Chiave:',
    'phone-key-desc': 'Senza il tuo telefono, l\'accesso è impossibile – anche con la tua password',
    'biometric-title': 'Pronto per Biometria:',
    'biometric-desc': 'Supporta riconoscimento delle impronte o facciale quando disponibile',
    'silent-secure-title': 'Silenzioso e Sicuro:',
    'silent-secure-desc': 'Nessun passaggio extra per te – massima protezione in background',
    'identity-private': 'La tua identità rimane privata. Il tuo accesso rimane protetto.',
    'trust-invisible': 'ALPHAG8 ID KEY – Perché la fiducia dovrebbe essere invisibile, ma infrangibile.',
    ...
    // Account Creation System - Italian
    'create-digital-identity': 'Crea Identità Digitale',
    'digital-fingerprint-collection': 'Raccolta Impronta Digitale',
    'create-secure-digital-identity': 'Crea la tua identità digitale sicura',
    'enter-first-name': 'Inserisci nome',
    'enter-last-name': 'Inserisci cognome',
    'social-security-fiscal-number': 'Codice Fiscale / SSN',
    'enter-fiscal-number': 'Inserisci codice fiscale',
    'enter-telephone': 'Inserisci telefono',
    'email-address': 'Indirizzo Email',
    'enter-email': 'Inserisci email',
    'creating-account': 'Creazione Account...',
    'digital-identity-created': 'Identità Digitale Creata',
    'your-alphag8-id-ready': 'Il tuo ALPHAG8 ID KEY è pronto',
    'save-your-alphag8-id-securely': 'Salva il tuo ALPHAG8 ID in modo sicuro',
    'use-this-id-for-future-access': 'Usa questo ID per gli accessi futuri',
    'proceed-to-create-account-types': 'Procedi alla creazione dei tipi di account',
    'access-co2-certification-features': 'Accedi alle funzionalità di certificazione CO₂',
    'continue-to-account-setup': 'Continua alla Configurazione Account',
    'please-fill-all-fields': 'Si prega di compilare tutti i campi',
    'account-created-successfully': 'Account Creato con Successo',
    'your-digital-identity-is-ready': 'La tua identità digitale è pronta',
    ...
    'fagri-id': 'FAGRI ID',
    'corporate-farmer-account': 'Account Aziendale Agricolo',
    'corporate-account-description': 'Per aziende agricole e agroforestali',
    'manage-multiple-co2-projects': 'Gestisci progetti CO₂ multipli',
    'team-member-access-control': 'Controllo accesso membri del team',
    'company-certification-tracking': 'Tracciamento certificazioni aziendali',
    'financial-reporting-tools': 'Strumenti di reportistica finanziaria',
    'bulk-project-submissions': 'Invio progetti in blocco',
    'corporate-dashboard-access': 'Accesso dashboard aziendale',
    'full-certification-access': 'Accesso completo certificazioni',
    'valid-fagri-id-required': 'FAGRI ID valido richiesto',
    'company-registration-documents': 'Documenti di registrazione aziendale',
    'authorized-representative-verification': 'Verifica rappresentante autorizzato',
    'corporate-kyc-completion': 'Completamento KYC aziendale',
    'admin-management-account': 'Account Amministrazione',
    'admin-account-description': 'Per amministratori di sistema',
    'full-platform-administration': 'Amministrazione completa piattaforma',
    'user-account-management': 'Gestione account utenti',
    'system-configuration-access': 'Accesso configurazione sistema',
    'comprehensive-reporting-tools': 'Strumenti di reportistica completi',
    'audit-trail-monitoring': 'Monitoraggio trail audit',
    'security-settings-control': 'Controllo impostazioni sicurezza',
    'global-dashboard-overview': 'Panoramica dashboard globale',
    'complete-system-access': 'Accesso completo al sistema',
    'administrator-authorization': 'Autorizzazione amministratore',
    'enhanced-security-verification': 'Verifica sicurezza avanzata',
    'management-approval-required': 'Approvazione management richiesta',
    'certification-control-account': 'Account Controllo Certificazioni',
    'certification-account-description': 'Per uffici audit e certificazione',
    'application-review-access': 'Accesso revisione applicazioni',
    'document-verification-tools': 'Strumenti verifica documenti',
    'certification-approval-workflow': 'Workflow approvazione certificazioni',
    'audit-documentation-system': 'Sistema documentazione audit',
    'compliance-monitoring-dashboard': 'Dashboard monitoraggio conformità',
    'quality-control-interfaces': 'Interfacce controllo qualità',
    'certification-authority-access': 'Accesso autorità certificazione',
    'certification-authority-credentials': 'Credenziali autorità certificazione',
    'professional-qualifications-verification': 'Verifica qualifiche professionali',
    'audit-office-authorization': 'Autorizzazione ufficio audit',
    'key-features': 'Caratteristiche Principali',
    'requirements': 'Requisiti',
    'selected-account-type': 'Tipo di account selezionato',
    'create-account': 'Crea Account',
    'important-information': 'Informazioni Importanti',
    'account-type-determines-access-level': 'Il tipo di account determina il livello di accesso',
    'all-accounts-require-fagri-id-verification': 'Tutti gli account richiedono verifica FAGRI ID',
    'additional-verification-may-be-required': 'Potrebbero essere richieste verifiche aggiuntive',
    'account-permissions-can-be-modified-later': 'Le autorizzazioni account possono essere modificate successivamente',
    'account-type-created': 'Tipo di Account Creato',
    'account-setup-completed': 'Configurazione account completata',
    ...
    'org-street-address': 'Indirizzo',
    'org-enter-street-address': 'Via/Piazza, numero civico',
    'org-address-line-2': 'Indirizzo Linea 2',
    'org-enter-address-line-2': 'Interno, scala, piano (opzionale)',
    'org-city': 'Città',
    'org-enter-city': 'Inserisci città',
    'org-postal-code': 'Codice Postale',
    'org-enter-postal-code': 'Inserisci CAP',
    'org-province-state': 'Provincia/Stato',
    'org-enter-province-state': 'Inserisci provincia',
    'org-country': 'Paese',
    'org-enter-country': 'Inserisci paese',
    'operational-headquarters-address': 'Sede Operativa',
    'org-operational-address-note': 'Compila solo se diversa dalla sede legale',
    'pec-address': 'Indirizzo PEC',
    
    // Dynamic Asset Management
    'add-machinery': 'Aggiungi Macchinario',
    'add-building': 'Aggiungi Edificio',
    'add-renewable-energy': 'Aggiungi Energia Rinnovabile',
    'machinery-item': 'Macchinario',
    'building-item': 'Edificio',
    'renewable-energy-item': 'Impianto Rinnovabile',
    'machinery-type': 'Tipo Macchinario',
    'select-machinery-type': 'Seleziona tipo macchinario',
    'tractor': 'Trattore',
    'harvester': 'Mietitrebbia',
    'planter': 'Seminatrice',
    'sprayer': 'Irroratrice',
    'cultivator': 'Coltivatore',
    'irrigation-system': 'Sistema Irrigazione',
    'other-machinery': 'Altro Macchinario',
    'model-brand': 'Modello/Marca',
    'enter-model-brand': 'Inserisci modello e marca',
    'capacity-power': 'Capacità/Potenza',
    'enter-capacity-power': 'Inserisci capacità o potenza',
    'additional-description': 'Descrizione Aggiuntiva',
    'enter-additional-info': 'Inserisci informazioni aggiuntive',
    'building-type': 'Tipo Edificio',
    'select-building-type': 'Seleziona tipo edificio',
    'warehouse': 'Magazzino',
    'stable': 'Stalla',
    'greenhouse': 'Serra',
    'storage-silo': 'Silo di Stoccaggio',
    'processing-facility': 'Impianto di Lavorazione',
    'office-building': 'Edificio Uffici',
    'other-building': 'Altro Edificio',
    'size-area': 'Dimensione/Area',
    'enter-size-area': 'Inserisci dimensione o area',
    'purpose-use': 'Scopo/Utilizzo',
    'enter-purpose-use': 'Inserisci scopo o utilizzo',
    'installed-capacity': 'Capacità Installata',
    'enter-installed-capacity': 'Inserisci capacità installata (kW/MW)',
    'production-capacity': 'Capacità Produttiva',
    'enter-production-capacity': 'Inserisci capacità produttiva (kWh/MWh)',
    'location-area': 'Localizzazione/Area',
    'enter-location-area': 'Inserisci localizzazione o area',
    ...
    // Project Creation Modal Italian translations (project- prefixed to avoid conflicts)
    'project-create-new': 'Crea Nuovo Progetto',
    'project-create-description': 'Crea un nuovo progetto di certificazione CO₂ conforme al standard UNI-PdR 2025',
    'project-type-selection': 'Selezione Tipo Progetto',
    'project-carbon-farming': 'Progetto Carbon Farming',
    'project-carbon-farming-desc': 'Progetti agricoli e agroforestali per la cattura di CO₂ atmosferica',
    'project-renewable-energy': 'Progetto Energie Rinnovabili',
    'project-renewable-energy-desc': 'Progetti energetici per evitare emissioni di CO₂ da fonti fossili',
    'project-forestation': 'Progetto Forestazione',
    'project-forestation-desc': 'Creazione e gestione di foreste per il sequestro a lungo termine di CO₂',
    'project-co2-sequestration': 'Sequestro CO₂ Agricolo',
    'project-co2-reduction': 'Riduzione Emissioni CO₂',
    'project-basic-info': 'Informazioni Base',
    'project-technical-details': 'Dettagli Tecnici',
    'project-investment-timeline': 'Investimenti e Tempistiche',
    'project-name-field': 'Nome Progetto',
    'project-enter-name': 'Inserisci nome del progetto',
    'project-location-field': 'Ubicazione Progetto',
    'project-enter-location': 'Inserisci ubicazione del progetto',
    'project-description-field': 'Descrizione Progetto',
    'project-describe-objectives': 'Descrivi gli obiettivi e le caratteristiche del progetto',
    'project-duration-field': 'Durata Progetto (anni)',
    'project-enter-duration': 'Inserisci durata in anni',
    'project-crop-type': 'Tipo Coltura',
    'project-select-crop': 'Seleziona tipo di coltura',
    'project-herbaceous-crops': 'Colture Erbacee',
    'project-tree-crops': 'Colture Arboree',
    'project-agroforestry': 'Agroforestali',
    'project-pasture-grassland': 'Pascoli e Prati',
    'project-farming-method': 'Metodo Agricolo',
    'project-select-method': 'Seleziona metodo agricolo',
    'project-conventional': 'Agricoltura Convenzionale',
    'project-organic': 'Agricoltura Biologica',
    'project-conservation': 'Agricoltura Conservativa',
    'project-regenerative': 'Agricoltura Rigenerativa',
    'project-area-hectares': 'Superficie Coltivata (ettari)',
    'project-enter-area': 'Inserisci superficie in ettari',
    'project-co2-sequestration-expected': 'Sequestro CO₂ Previsto',
    'project-enter-co2-tons': 'Inserisci tonnellate CO₂ per anno',
    'project-energy-type': 'Tipo Energia',
    'project-select-energy': 'Seleziona tipo di energia',
    'project-solar-pv': 'Solare Fotovoltaico',
    'project-solar-thermal': 'Solare Termico',
    'project-wind': 'Turbine Eoliche',
    'project-hydro': 'Idroelettrico',
    'project-biomass': 'Energia da Biomasse',
    'project-biogas': 'Produzione Biogas',
    'project-geothermal': 'Geotermico',
    'project-capacity-kw': 'Potenza Installata (kW)',
    'project-enter-capacity': 'Inserisci potenza in kW',
    'project-co2-reduction-expected': 'Riduzione CO₂ Prevista',
    'project-installation-location': 'Ubicazione Impianto',
    'project-enter-installation': 'Inserisci ubicazione dell\'impianto',
    
    // Forestation Project Translations - Italian
    'project-forest-type': 'Tipo di Foresta',
    'project-select-forest-type': 'Seleziona tipo di foresta',
    'project-mixed-forest': 'Foresta Mista',
    'project-deciduous-forest': 'Foresta Decidua',
    'project-coniferous-forest': 'Foresta di Conifere',
    'project-mediterranean-forest': 'Foresta Mediterranea',
    'project-riparian-forest': 'Foresta Ripariale',
    'project-tree-species': 'Specie Arboree',
    'project-select-species': 'Seleziona specie arboree',
    'project-oak': 'Quercia',
    'project-beech': 'Faggio',
    'project-pine': 'Pino',
    'project-spruce': 'Abete Rosso',
    'project-chestnut': 'Castagno',
    'project-poplar': 'Pioppo',
    'project-willow': 'Salice',
    'project-mixed-native': 'Miste Autoctone',
    'project-forest-area-hectares': 'Superficie Forestale (ettari)',
    'project-enter-forest-area': 'Inserisci superficie forestale in ettari',
    'project-tree-density-ha': 'Densità Alberi (per ettaro)',
    'project-enter-density': 'Inserisci numero alberi per ettaro',
    'project-forest-co2-sequestration': 'Sequestro CO₂ Forestale',
    'project-enter-forest-co2': 'Inserisci tonnellate CO₂ sequestrate',
    
    // Formula Display Translations - Italian
    'show-formula': 'Mostra Formula',
    'formula-transparency': 'Trasparenza Algoritmo',
    'calculation-summary': 'Riepilogo Calcoli',
    'view-full-calculations': 'Visualizza Calcoli Completi',
    
    'project-investment-euro': 'Capacità di Investimento (€)',
    'project-enter-investment': 'Inserisci importo investimento',
    'project-start-date': 'Data Inizio Progetto',
    'project-completion-date': 'Data Completamento Stimata',
    'project-compliance-requirements': 'Requisiti di Conformità',
    'project-documentation-required': 'Documentazione progetto richiesta',
    'project-blockchain-automatic': 'Registrazione blockchain automatica',
    'project-buffer-required': 'Buffer del 15% richiesto',
    'project-verification-needed': 'Verifica di terzi necessaria',
    'project-cancel': 'Annulla',
    'project-create-btn': 'Crea Progetto',
    'project-creating': 'Creazione Progetto',
    'project-created-success': 'Progetto Creato con Successo',
    'project-submitted-review': 'Il progetto è stato inviato per la revisione',
    'project-failed-create': 'Impossibile creare il progetto',

    // My Projects Display translations
    'total-investment': 'Investimento Totale',
    'co2-impact': 'Impatto CO₂',
    'back-to-dashboard': 'Torna alla Dashboard',
    
    // KYC Upload Redesigned Translations - Italian
    'kyc-verification-description': 'Verifica della tua identità secondo lo standard EUFD2025-001',
    'kyc-personal-verification': 'Verifica Persona Fisica',
    'kyc-personal-documents-required': 'Documenti di identità personale richiesti',
    'kyc-company-verification': 'Verifica Azienda',
    'kyc-company-documents-required': 'Documenti aziendali richiesti',
    'kyc-id-document-front': 'Documento di Identità (Fronte)',
    'kyc-id-document-back': 'Documento di Identità (Retro)',
    'kyc-address-proof': 'Prova di Residenza',
    'kyc-selfie-verification': 'Selfie di Verifica',
    'kyc-business-registration': 'Registrazione Aziendale',
    'kyc-tax-certificate': 'Certificato Fiscale',
    'kyc-director-identification': 'Identificazione Direttore',
    'kyc-company-address-proof': 'Prova Indirizzo Aziendale',
    'kyc-required': 'Richiesto',
    'kyc-uploading': 'Caricamento...',
    'kyc-upload-document': 'Carica Documento',
    'kyc-replace-document': 'Sostituisci Documento',
    'kyc-status-approved': 'Approvato',
    'kyc-status-rejected': 'Rifiutato',
    'kyc-status-pending': 'In Attesa',
    'kyc-document-uploaded-success': 'Documento caricato con successo!',
    'kyc-upload-failed': 'Caricamento fallito. Riprova.',
    'kyc-security-notice-title': 'Sicurezza e Privacy',
    'kyc-security-notice-description': 'I tuoi documenti sono crittografati con standard bancari svizzeri e protetti con infrastruttura militare.',
    'kyc-documents-uploaded': 'Documenti caricati',
    'kyc-submit-verification': 'Invia per Verifica',
    'actions': 'Azioni',
    ...
    // Account Extension Modal Italian Translations
    'please-fill-required-fields': 'Compila tutti i campi obbligatori.',
    'bank-transfer-submitted': 'Bonifico Bancario Inviato',
    'manual-activation-required': 'Attivazione manuale richiesta dall\'amministratore.',
    'extend-account': 'Estendi Account',
    'pricing-breakdown': 'Dettaglio Prezzi',
    'vat': 'IVA',
    'instant-payment': 'Pagamento Istantaneo',
    'traditional-payment': 'Pagamento Tradizionale',
    'credit-card-details': 'Dettagli Carta di Credito',
    'back': 'Indietro',
    'cardholder-name': 'Nome Titolare Carta',
    'enter-cardholder-name': 'Inserisci nome titolare carta',
    'cvv-code': 'Codice CVV',
    'billing-address': 'Indirizzo di Fatturazione',
    'enter-billing-address': 'Inserisci indirizzo di fatturazione',
    'enter-city': 'Inserisci città',
    'name-verification-required': 'Verifica Nome Richiesta',
    'cardholder-name-must-match-account': 'Il nome del titolare della carta deve corrispondere al nome del titolare del conto per la verifica di sicurezza.',
    'process-payment': 'Elabora Pagamento',
    'account-holder-name': 'Nome Titolare Conto',
    'enter-account-holder-name': 'Inserisci nome titolare conto',
    'iban-number': 'Numero IBAN',
    'enter-bank-name': 'Inserisci nome banca',
    'pricing-note': 'Nota sui Prezzi',
    'transfer-reference': 'Riferimento Bonifico',
    'reference-auto-generated': 'Riferimento generato automaticamente',
    'manual-activation-notice': 'Avviso Attivazione Manuale',
    'bank-transfer-manual-verification': 'I bonifici bancari richiedono verifica manuale da parte dell\'amministratore dopo la ricezione del pagamento.',
    'submit-bank-transfer': 'Invia Bonifico Bancario',
    'processing-payment': 'Elaborazione Pagamento...',
    'authorization-request-submitted': 'Richiesta di Autorizzazione Inviata',
    'admin-will-review-request': 'L\'amministratore esaminerà la tua richiesta',
    ...
    'photo-upload-optional': 'Caricamento foto opzionale',
    ...
    'co2-cert-process-title': 'Processo di Certificazione',
    'co2-cert-process-step1': 'Registrazione Progetto',
    'co2-cert-process-step1-desc': 'Invio dei dettagli del progetto e documentazione attraverso piattaforma sicura',
    'co2-cert-process-step2': 'Revisione Multi-Stakeholder',
    'co2-cert-process-step2-desc': 'Validazione collaborativa da parte delle organizzazioni partner',
    'co2-cert-process-step3': 'Registrazione Blockchain',
    'co2-cert-process-step3-desc': 'Certificazione immutabile registrata sulla rete G8Chain',
    'co2-cert-process-step4': 'Emissione Crediti',
    'co2-cert-process-step4-desc': 'Crediti di carbonio verificati emessi e disponibili per la negoziazione',
    'co2-cert-benefits-title': 'Benefici della Piattaforma',
    'co2-cert-benefit1-title': 'Trasparenza Completa',
    'co2-cert-benefit1-desc': 'Tracciabilità completa e verifica blockchain per tutte le transazioni',
    'co2-cert-benefit2-title': 'Conformità Normativa',
    'co2-cert-benefit2-desc': 'Conformità agli standard EUFD2025-001 e ISO 14064',
    'co2-cert-benefit3-title': 'Accesso al Mercato',
  ...
  en: {
    ...
    'co2-cert-process-title': 'Certification Process',
    'co2-cert-process-step1': 'Project Registration',
    'co2-cert-process-step1-desc': 'Submit project details and documentation through secure platform',
    'co2-cert-process-step2': 'Multi-Stakeholder Review',
    'co2-cert-process-step2-desc': 'Collaborative validation by partner organizations',
    'co2-cert-process-step3': 'Blockchain Recording',
    'co2-cert-process-step3-desc': 'Immutable certification recorded on G8Chain network',
    'co2-cert-process-step4': 'Credit Issuance',
    'co2-cert-process-step4-desc': 'Verified carbon credits issued and available for trading',
    'co2-cert-benefits-title': 'Platform Benefits',
    'co2-cert-benefit1-title': 'Complete Transparency',
    'co2-cert-benefit1-desc': 'Full audit trail and blockchain verification for all transactions',
    'co2-cert-benefit2-title': 'Regulatory Compliance',
    'co2-cert-benefit2-desc': 'EUFD2025-001 and ISO 14064 standards compliance',
    'co2-cert-benefit3-title': 'Market Access',
    ...
    'pricing-note': 'Nota sui Prezzi',
    'first-time-creation-fee': 'Creazione impronta digitale',
    'first-year-fee': 'Prima annualità',
    'subtotal': 'Subtotale',
    'italian-vat': 'IVA Italiana (22%)',
    'total-amount-with-vat': 'Totale (incl. IVA)',
    'annual-renewal-fee': 'Ogni anno successivo: €14.64 (€12.00 + 22% IVA)',
    'only-applies-initial': 'si applica solo alla registrazione iniziale',
    'extensions-cost': 'Le estensioni account costano',
    'per-year': 'all\'anno',
    'profile-photo': 'Foto Profilo',
    'upload-profile-photo': 'Carica Foto Profilo',
    'photo-upload-optional': 'Opzionale - Per identificazione nel profilo',
    'photo-uploaded-success': 'Foto caricata con successo!',
    'photo-upload-failed': 'Caricamento foto fallito',
    'select-photo': 'Seleziona Foto',
    'remove-photo': 'Rimuovi Foto',
    'issued-to': 'Rilasciato a',
    ...
    'org-street-address': 'Street Address',
    'org-enter-street-address': 'Street/Square, civic number',
    'org-address-line-2': 'Address Line 2',
    'org-enter-address-line-2': 'Apartment, floor, suite (optional)',
    'org-city': 'City',
    'org-enter-city': 'Enter city',
    'org-postal-code': 'Postal Code',
    'org-enter-postal-code': 'Enter postal code',
    'org-province-state': 'Province/State',
    'org-enter-province-state': 'Enter province',
    'org-country': 'Country',
    'org-enter-country': 'Enter country',
    'org-operational-address-note': 'Fill only if different from legal address',
    
    // Dynamic Asset Management
    'add-machinery': 'Add Machinery',
    'add-building': 'Add Building',
    'add-renewable-energy': 'Add Renewable Energy',
    'machinery-item': 'Machinery',
    'building-item': 'Building',
    'renewable-energy-item': 'Renewable Plant',
    'machinery-type': 'Machinery Type',
    'select-machinery-type': 'Select machinery type',
    'tractor': 'Tractor',
    'harvester': 'Harvester',
    'planter': 'Planter',
    'sprayer': 'Sprayer',
    ...
    'enter-model-brand': 'Enter model and brand',
    'capacity-power': 'Capacity/Power',
    'enter-capacity-power': 'Enter capacity or power',
    ...
    'size-area': 'Size/Area',
    'enter-size-area': 'Enter size or area',
    'purpose-use': 'Purpose/Use',
    'enter-purpose-use': 'Enter purpose or use',
    'renewable-energy-type': 'Renewable Energy Type',
    'select-renewable-type': 'Select renewable energy type',
    ...
    'enter-installed-capacity': 'Enter installed capacity (kW/MW)',
    'production-capacity': 'Production Capacity',
    'enter-production-capacity': 'Enter production capacity (kWh/MWh)',
    'location-area': 'Location/Area',
    'enter-location-area': 'Enter location or area',
    ...
    // Hierarchical Business System - English
    'business-hierarchy-desc': 'Select your main sector, then specify the category and specific activities',
    'main-business-sector': 'Main Business Sector',
    'select-main-sector': 'Select Main Sector',
    'business-sub-sector': 'Sub-Sector',
    'select-sub-sector': 'Select Sub-Sector',
    'specific-activities': 'Specific Activities',
    'multiple-choice': 'Multiple Choice',
    'selected-activities': 'Selected Activities',
    'additional-business-info': 'Additional Information',
    'describe-additional-info': 'Describe additional information about your business...',
    
    // Main Business Sectors - English
    ...
    'olive-production': 'Olive Production',
    'fruit-growing': 'Fruit Growing',
    'organic-farming': 'Organic Farming',
    'mixed-farming': 'Mixed Farming',
    
    // Cooperative Sub-sectors - English
    'agricultural-cooperative': 'Agricultural Cooperative',
    'wine-cooperative': 'Wine Cooperative',
    'dairy-cooperative': 'Dairy Cooperative',
    'fruit-vegetable-cooperative': 'Fruit & Vegetable Cooperative',
    'marketing-cooperative': 'Marketing Cooperative',
    'supply-cooperative': 'Supply Cooperative',
    
    // Industry Sub-sectors - English
    ...
    // Renewable Energy Sub-sectors - English
    'solar-farms': 'Solar Farms',
    'wind-energy': 'Wind Energy',
    
    // Services Sub-sectors - English
    ...
    'financing-services': 'Financing Services',
    'insurance-services': 'Insurance Services',

    // Activities - English (abbreviated for space)
    'cereals': 'Cereals',
    ...
    'organic-cereals': 'Organic Cereals',
    ...
    'grape-processing': 'Grape Processing',
    ...
    'export': 'Export',
    'promotion': 'Promotion',
    'input-purchasing': 'Input Purchasing',
    ...
    'powder-production': 'Powder Production',
    ...
    'flour-production': 'Flour Production',
    'feed-production': 'Feed Production',
    'grain-cleaning': 'Grain Cleaning',
    'storage': 'Storage',
    ...
    'gas-upgrading': 'Gas Upgrading',
    'electricity-generation': 'Electricity Generation',
    'heat-production': 'Heat Production',
    'dual-use-systems': 'Dual Use Systems',
    'crop-energy-optimization': 'Crop-Energy Optimization',
    ...
    'co2-certification': 'CO₂ Certification',
    'auditing': 'Auditing',
    ...
    'equipment-insurance': 'Equipment Insurance',
    ...
    // Project Creation Modal - English
    'project-create-new': 'Create New Project',
    'project-create-description': 'Create a new CO₂ certification project compliant with UNI-PdR 2025 standards',
    'project-carbon-farming': 'Carbon Farming Project',
    'project-carbon-farming-desc': 'CO₂ sequestration through sustainable agricultural practices',
    'project-co2-sequestration': 'Agricultural CO₂ Sequestration',
    'project-renewable-energy': 'Renewable Energy Project',
    'project-renewable-energy-desc': 'CO₂ emission reduction through renewable energy generation',
    'project-co2-reduction': 'CO₂ Emission Reduction',
    'project-basic-info': 'Basic Information',
    'project-technical-details': 'Technical Details',
    'project-investment-timeline': 'Investment & Timeline',
    'project-name-field': 'Project Name',
    'project-enter-name': 'Enter project name',
    'project-location-field': 'Project Location',
    'project-enter-location': 'Enter project location',
    'project-description-field': 'Project Description',
    'project-describe-objectives': 'Describe project objectives and implementation',
    'project-duration-field': 'Project Duration (years)',
    'project-enter-duration': 'Enter duration in years',
    'project-crop-type': 'Crop Type',
    'project-select-crop': 'Select crop type',
    'project-herbaceous-crops': 'Herbaceous Crops',
    'project-tree-crops': 'Tree Crops',
    'project-agroforestry': 'Agroforestry',
    'project-pasture-grassland': 'Pasture/Grassland',
    'project-farming-method': 'Farming Method',
    'project-select-method': 'Select farming method',
    'project-conventional': 'Conventional Farming',
    'project-organic': 'Organic Farming',
    'project-conservation': 'Conservation Agriculture',
    'project-regenerative': 'Regenerative Farming',
    'project-area-hectares': 'Cultivated Area (hectares)',
    'project-enter-area': 'Enter area in hectares',
    'project-co2-sequestration-expected': 'Expected CO₂ Sequestration (t/year)',
    'project-enter-co2-tons': 'Enter CO₂ tons per year',
    'project-energy-type': 'Energy Type',
    'project-select-energy': 'Select energy type',
    'project-solar-pv': 'Solar Photovoltaic',
    'project-solar-thermal': 'Solar Thermal',
    'project-wind': 'Wind Turbines',
    'project-hydro': 'Hydroelectric',
    'project-biomass': 'Biomass Energy',
    'project-biogas': 'Biogas Production',
    'project-geothermal': 'Geothermal',
    'project-capacity-kw': 'Installed Capacity (kW)',
    'project-enter-capacity': 'Enter capacity in kW',
    'project-co2-reduction-expected': 'Expected CO₂ Reduction (t/year)',
    'project-installation-location': 'Installation Location',
    'project-enter-installation': 'Enter installation location',
    
    // Forestation Project Translations - English
    'project-forest-type': 'Forest Type',
    'project-select-forest-type': 'Select forest type',
    'project-mixed-forest': 'Mixed Forest',
    'project-deciduous-forest': 'Deciduous Forest',
    'project-coniferous-forest': 'Coniferous Forest',
    'project-mediterranean-forest': 'Mediterranean Forest',
    'project-riparian-forest': 'Riparian Forest',
    'project-tree-species': 'Tree Species',
    'project-select-species': 'Select tree species',
    'project-oak': 'Oak',
    'project-beech': 'Beech',
    'project-pine': 'Pine',
    'project-spruce': 'Spruce',
    'project-chestnut': 'Chestnut',
    'project-poplar': 'Poplar',
    'project-willow': 'Willow',
    'project-mixed-native': 'Mixed Native',
    'project-forest-area-hectares': 'Forest Area (hectares)',
    'project-enter-forest-area': 'Enter forest area in hectares',
    'project-tree-density-ha': 'Tree Density (per hectare)',
    'project-enter-density': 'Enter trees per hectare',
    'project-forest-co2-sequestration': 'Forest CO₂ Sequestration',
    'project-enter-forest-co2': 'Enter CO₂ tonnes sequestered',
    
    // Formula Display Translations - English
    'show-formula': 'Show Formula',
    'formula-transparency': 'Algorithm Transparency',
    'calculation-summary': 'Calculation Summary',
    'view-full-calculations': 'View Full Calculations',
    
    'project-investment-euro': 'Investment Capacity (€)',
    'project-enter-investment': 'Enter investment amount',
    'project-start-date': 'Project Start Date',
    'project-completion-date': 'Estimated Completion Date',
    'project-compliance-requirements': 'Compliance Requirements',
    'project-documentation-required': 'Project documentation required',
    'project-blockchain-automatic': 'Blockchain registration automatic',
    'project-buffer-required': '15% buffer required',
    'project-verification-needed': 'Third-party verification needed',
    'project-cancel': 'Cancel',
    'project-creating': 'Creating Project',
    'project-create-btn': 'Create Project',
    'project-created-success': 'Project Created Successfully',
    'project-submitted-review': 'Project submitted for review',
    'project-failed-create': 'Failed to create project',

    // My Projects Display - English
    'total-investment': 'Total Investment',
    'co2-impact': 'CO₂ Impact',
    'back-to-dashboard': 'Back to Dashboard',
    
    // KYC Upload Redesigned Translations - English
    'kyc-verification-description': 'Verify your identity according to EUFD2025-001 standard',
    'kyc-personal-verification': 'Personal Verification',
    'kyc-personal-documents-required': 'Personal identity documents required',
    'kyc-company-verification': 'Company Verification',
    'kyc-company-documents-required': 'Company documents required',
    'kyc-id-document-front': 'ID Document (Front)',
    'kyc-id-document-back': 'ID Document (Back)',
    'kyc-address-proof': 'Proof of Residence',
    'kyc-selfie-verification': 'Selfie Verification',
    'kyc-business-registration': 'Business Registration',
    'kyc-tax-certificate': 'Tax Certificate',
    'kyc-director-identification': 'Director Identification',
    'kyc-company-address-proof': 'Company Address Proof',
    'kyc-required': 'Required',
    'kyc-uploading': 'Uploading...',
    'kyc-upload-document': 'Upload Document',
    'kyc-replace-document': 'Replace Document',
    'kyc-status-approved': 'Approved',
    'kyc-status-rejected': 'Rejected',
    'kyc-status-pending': 'Pending',
    'kyc-document-uploaded-success': 'Document uploaded successfully!',
    'kyc-upload-failed': 'Upload failed. Please try again.',
    'kyc-security-notice-title': 'Security & Privacy',
    ...
    'business-description': 'Select your main sector, then specify the category and specific activities',
    'contact-preferences': 'Contact Preferences',
    'website': 'Website',
    'website-placeholder': 'https://your-website.com',
    'sito-web': 'Website',
    'preferred-contact-methods': 'Preferred Contact Methods',
    'metodi-di-contatto-preferiti': 'Preferred Contact Methods',
    'contact-via-email': 'Contact me via email',
    'contattami-via-email': 'Contact me via email',
    'contact-via-phone': 'Contact me by phone',
    'contattami-per-telefono': 'Contact me by phone',
    'website-url': 'Website',
    'contact-by-email': 'Contact me via email',
    'contact-by-phone': 'Contact me by phone',
    'agreements-consent': 'Agreements and Consents',
    'marketing-consent-text': 'I consent to receive updates about the platform and other FAGRI activities',
    'agreements-consents': 'Agreements and Consents',
    'platform-updates-consent': 'I consent to receive updates about the platform and other FAGRI activities',
    'additional-notes': 'Additional Notes',
    'additional-notes-placeholder': 'Any additional information...',
    'additional-info-placeholder': 'Any additional information...',
    ...
    // Account Creation System - English
    'create-digital-identity': 'Create Digital Identity',
    'digital-fingerprint-collection': 'Digital Fingerprint Collection',
    'create-secure-digital-identity': 'Create your secure digital identity',
    'enter-first-name': 'Enter first name',
    'enter-last-name': 'Enter last name',
    'social-security-fiscal-number': 'Social Security / Fiscal Number',
    'enter-fiscal-number': 'Enter fiscal number',
    'enter-telephone': 'Enter telephone',
    'email-address': 'Email Address',
    'enter-email': 'Enter email',
    'creating-account': 'Creating Account...',
    'digital-identity-created': 'Digital Identity Created',
    'your-alphag8-id-ready': 'Your ALPHAG8 ID KEY is ready',
    'save-your-alphag8-id-securely': 'Save your ALPHAG8 ID securely',
    'use-this-id-for-future-access': 'Use this ID for future access',
    'proceed-to-create-account-types': 'Proceed to create account types',
    'access-co2-certification-features': 'Access CO₂ certification features',
    'continue-to-account-setup': 'Continue to Account Setup',
    'please-fill-all-fields': 'Please fill all fields',
    'account-created-successfully': 'Account Created Successfully',
    'your-digital-identity-is-ready': 'Your digital identity is ready',
    ...
    'corporate-farmer-account': 'Corporate Farmer Account',
    'corporate-account-description': 'For agricultural and agroforestry companies',
    'manage-multiple-co2-projects': 'Manage multiple CO₂ projects',
    'team-member-access-control': 'Team member access control',
    'company-certification-tracking': 'Company certification tracking',
    'financial-reporting-tools': 'Financial reporting tools',
    'bulk-project-submissions': 'Bulk project submissions',
    'corporate-dashboard-access': 'Corporate dashboard access',
    'full-certification-access': 'Full certification access',
    'valid-fagri-id-required': 'Valid FAGRI ID required',
    'company-registration-documents': 'Company registration documents',
    'authorized-representative-verification': 'Authorized representative verification',
    'corporate-kyc-completion': 'Corporate KYC completion',
    'admin-management-account': 'Admin Management Account',
    'admin-account-description': 'For system administrators',
    'full-platform-administration': 'Full platform administration',
    'user-account-management': 'User account management',
    'system-configuration-access': 'System configuration access',
    'comprehensive-reporting-tools': 'Comprehensive reporting tools',
    'audit-trail-monitoring': 'Audit trail monitoring',
    'security-settings-control': 'Security settings control',
    'global-dashboard-overview': 'Global dashboard overview',
    'complete-system-access': 'Complete system access',
    'administrator-authorization': 'Administrator authorization',
    'enhanced-security-verification': 'Enhanced security verification',
    'management-approval-required': 'Management approval required',
    'certification-control-account': 'Certification Control Account',
    'certification-account-description': 'For audit and certification offices',
    'application-review-access': 'Application review access',
    'document-verification-tools': 'Document verification tools',
    'certification-approval-workflow': 'Certification approval workflow',
    'audit-documentation-system': 'Audit documentation system',
    'compliance-monitoring-dashboard': 'Compliance monitoring dashboard',
    'quality-control-interfaces': 'Quality control interfaces',
    'certification-authority-access': 'Certification authority access',
    'certification-authority-credentials': 'Certification authority credentials',
    'professional-qualifications-verification': 'Professional qualifications verification',
    'audit-office-authorization': 'Audit office authorization',
    'key-features': 'Key Features',
    'requirements': 'Requirements',
    'selected-account-type': 'Selected account type',
    'create-account': 'Create Account',
    'important-information': 'Important Information',
    'account-type-determines-access-level': 'Account type determines access level',
    'all-accounts-require-fagri-id-verification': 'All accounts require FAGRI ID verification',
    'additional-verification-may-be-required': 'Additional verification may be required',
    'account-permissions-can-be-modified-later': 'Account permissions can be modified later',
    'account-type-created': 'Account Type Created',
    'account-setup-completed': 'Account setup completed',
