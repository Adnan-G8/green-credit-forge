...
export const translations = {
  ...
  en: {
    ...
    'platform-intro-description': 'FAGRI.Digital has developed a digital platform covering the entire carbon credit certification process – from initial application to validation, issuance, and trading.',
