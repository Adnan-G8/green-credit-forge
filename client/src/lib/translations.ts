export const translations = {
  it: {
    ...
    'kyc-step-1': 'Verifica Identità',
    'kyc-step-2': 'Validazione Documenti',
    'kyc-step-3': 'Attivazione Account',
    'kyc-desc-1': 'Fornisci le tue informazioni personali per la verifica dell\'identità',
    'kyc-desc-2': 'Carica i documenti di identità richiesti per la validazione',
    'kyc-desc-3': 'Completa il processo e attiva la tua identità digitale ALPHAG8',
  ...
  en: {
    ...
    'kyc-step-1': 'Identity Verification',
    'kyc-step-2': 'Document Validation',
    'kyc-step-3': 'Account Activation',
    'kyc-desc-1': 'Provide your personal information for identity verification',
    'kyc-desc-2': 'Upload required identity documents for validation',
    'kyc-desc-3': 'Complete the process and activate your ALPHAG8 digital identity',
