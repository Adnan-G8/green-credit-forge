export const translations = {
  it: {
    ...
    'eufd-intro-text2': 'Sviluppato in partnership con un consorzio di partner tecnologici internazionali guidato da ALPHAG8 Digital Solutions Switzerland, inclusi G8Chain e altri, la piattaforma che supporta lo standard EUFD2025-001 è progettata per inaugurare una nuova era di fiducia, efficienza e trasparenza nella certificazione e commercio di CO₂ — alimentata da tecnologia blockchain, protocolli avanzati di protezione dati e architettura di sicurezza 3FA.',
