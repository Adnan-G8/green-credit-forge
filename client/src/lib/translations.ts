export const translations = {
  it: {
    ...
    'security-data-description': 'Tutti i dati personali e di progetto sono conservati esclusivamente su server in Svizzera, in conformità con il GDPR europeo e i più alti standard di sicurezza informatica.',
    'security-data-point1': 'Nessuna trasmissione o condivisione con terzi',
    'security-data-point2': 'Controllo completo dell\'utente su visibilità e autorizzazioni',
    'security-data-point3': 'Registrazione tracciabile delle interazioni basata su consenso',
  ...
  en: {
    ...
    'security-data-description': 'All personal and project data is stored exclusively on servers in Switzerland, in compliance with the European GDPR and top cybersecurity standards.',
    'security-data-point1': 'No third-party transmission or sharing',
    'security-data-point2': 'Full user control over visibility and permissions',
    'security-data-point3': 'Traceable, consent-based interaction logging',
