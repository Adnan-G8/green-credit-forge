export const translations = {
  it: {
    ...
    'partner1-title': 'Commissione Europea',
    'partner1-description': 'per l\'allineamento con gli obiettivi climatici e le normative UE',
    'partner2-title': 'Ministero dell\'Ambiente e della Sicurezza Energetica (Italia)',
    'partner2-description': 'per la coerenza normativa nazionale',
    'partner3-title': 'GSE (Gestore dei Servizi Energetici)',
    'partner3-description': 'per l\'integrazione con i registri energetici ed emissivi nazionali',
    'partner4-title': 'SUOLO E SALUTE',
    'partner4-description': 'organismo di certificazione indipendente e accreditato',
    'partner5-title': 'ISO e UNI',
    'partner5-description': 'per l\'adozione di standard tecnici internazionali e italiani',
  ...
  en: {
    ...
    'partner1-title': 'European Commission',
    'partner1-description': 'for alignment with EU climate objectives and regulations',
    'partner2-title': 'Ministry of Environment and Energy Security (Italy)',
    'partner2-description': 'for national regulatory consistency',
    'partner3-title': 'GSE (Energy Services Manager)',
    'partner3-description': 'for integration with national energy and emissions registries',
    'partner4-title': 'SOIL AND HEALTH',
    'partner4-description': 'independent and accredited certification body',
    'partner5-title': 'ISO and UNI',
    'partner5-description': 'for adoption of international and Italian technical standards',
