              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-emerald-800 mb-2">
                    {language === 'it' ? 'Cookie Sicuri e Protetti' : 'Secure and Protected Cookies'}
                  </h3>
                  <p className="text-emerald-700 mb-3">
                    {language === 'it' 
                      ? 'I nostri cookie sono gestiti con protocolli di sicurezza avanzati e memorizzati in infrastrutture certificate per garantire la massima protezione dei tuoi dati.'
                      : 'Our cookies are managed with advanced security protocols and stored in certified infrastructure to ensure maximum protection of your data.'}
                  </p>
                  <Link href="/security">
