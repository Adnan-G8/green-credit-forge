              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-emerald-800 mb-2">
                    {language === 'it' ? 'Massima Sicurezza per i Tuoi Dati' : 'Maximum Security for Your Data'}
                  </h3>
                  <p className="text-emerald-700 mb-3">
                    {language === 'it' 
                      ? 'La piattaforma Fagri Digital utilizza infrastrutture di sicurezza bancaria svizzera e protocolli avanzati per garantire la massima protezione dei tuoi dati personali e aziendali.'
                      : 'The Fagri Digital platform uses Swiss banking security infrastructure and advanced protocols to ensure maximum protection of your personal and business data.'}
                  </p>
                  <Link href="/security">
