            ...
            <div className="bg-white rounded-xl p-8 border border-slate-200">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-900">{t('co2-cert-compliance-ets')}</h4>
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="text-emerald-600 h-5 w-5 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-medium text-slate-900">{t('co2-cert-compliance-cbam')}</h4>
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="text-emerald-600 h-5 w-5 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-medium text-slate-900">{t('co2-cert-compliance-aml')}</h4>
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="text-emerald-600 h-5 w-5 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-medium text-slate-900">{t('co2-cert-compliance-paris')}</h4>
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="text-emerald-600 h-5 w-5 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-medium text-slate-900">{t('co2-cert-compliance-kyoto')}</h4>
