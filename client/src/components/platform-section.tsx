...
export function PlatformSection() {
  ...
  return (
    <section id="platform" className="py-20 gradient-bg relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-bold text-fagri-text mb-6 font-sans animate-slide-up">
              {t('platform-title')}
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="animate-slide-up">
              <div className="clean-card rounded-2xl p-8">
                <h3 className="text-2xl font-bold text-fagri-text mb-6">
                  Processo Passo dopo Passo
                </h3>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-fagri-green rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-white font-bold text-sm">1</span>
                    </div>
                    <div>
                      <h4 className="font-semibold text-fagri-text mb-2">
          ...
          <div className="clean-card rounded-2xl p-8 text-center">
            <h3 className="text-2xl font-bold text-fagri-text mb-4">
              Il Nostro Obiettivo
            </h3>
