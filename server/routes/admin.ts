...
const mockAuthorizationRequests = [
  {
    ...
    authorizationType: 'CO₂ Project Submission Rights',
    authorizationDescription: 'Berechtigung zur Einreichung und Verwaltung von CO₂-Zertifizierungsprojekten für landwirtschaftliche Betriebe',
    requestReason: 'Benötigt Zugang zur Plattform für die Zertifizierung von 3 Agrarprojekten (Biogas, Solarenergie, Präzisionslandwirtschaft)',
    assignedTeamMember: 'Maria Rossi',
    assignedTeamMemberEmail: 'maria.rossi@fagri.it',
    projectsRequested: ['Biogas-Anlage (50 kW)', 'Solarpark (200 kW)', 'Präzisionslandwirtschaft (150 ha)'],
    status: 'pending',
  ...
  },
  {
    ...
    accountType: 'Corporate Farmer',
    authorizationType: 'Individual CO₂ Project Access',
    authorizationDescription: 'Zugang für einzelnes CO₂-Zertifizierungsprojekt mit begrenzten Eingabe- und Uploadrechten',
    requestReason: 'Kleiner Landwirtschaftsbetrieb möchte 1 Windenergieprojekt zertifizieren lassen',
    assignedTeamMember: 'Giovanni Verdi',
    assignedTeamMemberEmail: 'giovanni.verdi@fagri.it',
    projectsRequested: ['Windenergie-Anlage (25 kW)'],
    status: 'approved',
    requestedAt: new Date(Date.now() - 172800000).toISOString(),
    fullName: 'Lucia Ferrari',
    email: 'lucia.ferrari@example.com',
    company: 'Azienda Agricola Ferrari',
    notes: 'Single wind project certification request'
  },
  {
    id: 'req-003',
    fagriId: 'FAGRI-3FLTH9G5-M8Z4R7P9-31',
    accountType: 'Administration',
    authorizationType: 'Full System Administration Rights',
    authorizationDescription: 'Vollständige Systemverwaltungsrechte: Benutzerverwaltung, Zertifizierungen bewilligen/zurücknehmen, Plattformkonfiguration, alle Projekte bearbeiten',
    requestReason: 'Administrativer Zugang erforderlich für Systemwartung, Benutzerverwaltung und vollständige Kontrolle über CO₂-Zertifizierungsprozesse',
    status: 'approved',
  ...
  },
  {
    ...
    accountType: 'Certification Control',
    authorizationType: 'Quality Review & Certification Authority',
    authorizationDescription: 'Berechtigung zur Qualitätsprüfung, Projektbewertung, Kommentierung und Empfehlungen für CO₂-Zertifizierungsprojekte',
    requestReason: 'Unabhängige Zertifizierungsstelle benötigt Zugang für Projektüberprüfung und Qualitätskontrolle gemäß ISO 14064 Standards',
    status: 'pending',
    requestedAt: new Date(Date.now() - 259200000).toISOString(),
    fullName: 'Dr. Stefan Müller',
    email: 'stefan.mueller@certify-co2.eu',
    company: 'EU Certification Authority',
    notes: 'Independent certification authority access request'
  }
];
