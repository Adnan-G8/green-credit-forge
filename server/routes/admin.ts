...
const mockAuthorizationRequests = [
  ...
  },
  {
    ...
    authorizationType: 'Internal Project Management',
    authorizationDescription: 'Vollzugriff auf interne Projektüberwachung und Qualitätskontrolle für FAGRI Digital Mitarbeiter',
    requestReason: 'Team-Mitglied benötigt Zugang zur Überwachung von Kundenprojekten und Kommunikation mit Zertifizierungsstellen',
    status: 'pending',
  ...
  },
  {
    ...
    authorizationType: 'System Administration Rights',
    authorizationDescription: 'Vollständige Systemverwaltungsrechte einschließlich Benutzerverwaltung und Plattformkonfiguration',
    requestReason: 'Administrativer Zugang erforderlich für Systemwartung, Benutzerverwaltung und technische Unterstützung',
    status: 'approved',
